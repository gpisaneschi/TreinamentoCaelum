package br.com.pisaneschi.cursolivro.adapter;
...
import br.com.pisaneschi.cursolivro.modelo.TipoDeCompra;
...
public class ItensAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        Picasso.with(holder.fotoLivro.getContext()).load(item.getLivro().getUrlFoto()).into(holder.fotoLivro);
